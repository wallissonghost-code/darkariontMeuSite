const RELEASE='wd-founder-3.7.3';
...
function isCriticalAsset(url){return /(?:app-updater|route-view-stability|ui-stability-3-7-2|spa|app-shell|rank-nav-ensure)\.(?:js|css)$/.test(url.pathname)}
