const RELEASE='wd-founder-3.7.5';
...
function isCriticalAsset(url){return /\/(app-updater|app-shell|spa|rank-nav-ensure|route-view-stability)\.js$/.test(url.pathname)||/\/(ui-stability-3-7-2|account-founder-v2|account-founder-final-375)\.css$/.test(url.pathname)}
