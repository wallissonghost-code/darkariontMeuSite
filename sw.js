const RELEASE='wd-founder-3.8.2';
...
function isCriticalAsset(url){return /\/(app-updater|app-shell|spa|rank|rank-access-gate|store-controller|unified-admin-shell|rank-admin)\.js$/.test(url.pathname)||/\/(theme-audit-382|navigation-performance-381|ui-stability-3-7-2|account-founder-v2|account-founder-final-375|store-rank-final-376|rank-access-rewards|rank-admin)\.css$/.test(url.pathname)}
