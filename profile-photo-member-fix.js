...
async function install(){
  ...
  input.addEventListener('change',async()=>{
    ...
    const previous=String(window.WDSession?.state?.profile?.foto||localStorage.getItem(localKey)||user.photoURL||'').trim();
    try{
